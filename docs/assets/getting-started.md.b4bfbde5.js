...
<span class="token function">yarn</span> <span class="token function">install</span> <span class="token operator">&amp;&amp;</span> <span class="token function">yarn</span> dev
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">]</span>
</code></pre></div><h3 id="set-up-a-new-user" tabindex="-1">Set up a new user <a class="header-anchor" href="#set-up-a-new-user" aria-hidden="true">#</a></h3><p>Define your users under the <code>config/users.json</code> configuration file<br> and create a <code>public/users/{username}</code> folder for each one.</p><p>Place an image called <code>avatar.jpg</code> in your profile folder.</p><h3 id="provide-some-media" tabindex="-1">Provide some media <a class="header-anchor" href="#provide-some-media" aria-hidden="true">#</a></h3><p>IG Planner supports different media types: image, video, album and iframe.</p><p>Add your media to your <code>public/users/{username}/media/</code> folder<br> and define all the media in the users configuration like the examples.</p><h3 id="media-support" tabindex="-1">Media support <a class="header-anchor" href="#media-support" aria-hidden="true">#</a></h3><p>IG Planner supports different media types: image, video, album and iframe.</p><h4 id="images" tabindex="-1">Images <a class="header-anchor" href="#images" aria-hidden="true">#</a></h4><div class="language-json"><pre><code><span class="token punctuation">{</span>
  <span class="token property">&quot;profile&quot;</span><span class="token operator">:</span> <span class="token punctuation">{</span>
    <span class="token property">&quot;media&quot;</span><span class="token operator">:</span> <span class="token punctuation">[</span>
      <span class="token punctuation">{</span>
